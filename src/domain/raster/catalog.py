...
from src.domain.raster.loaders.base_loader import BaseRasterLoader
...
from src.domain.raster.loaders.lightweight_metadata import LightweightMetadataExtractor, extract_metadata_with_progress
...
class RasterCatalog:
    ...
    def __init__(self, db_connection: DatabaseManager, app_config=None):
        ...
        self.config = app_config if app_config is not None else config
