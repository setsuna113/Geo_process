# src/raster_data/validators/coverage_validator.py
...
from src.domain.raster.loaders.base_loader import BaseRasterLoader, RasterMetadata
from src.base.grid import BaseGrid
...
class CoverageValidator:
    ...
    def validate_coverage(self, raster_path: Path, grid: BaseGrid) -> Dict[str, Any]:
        ...
        grid_resolution_meters = grid.resolution
        # Convert meters to degrees (approximate)
        grid_resolution = grid_resolution_meters / 111000.0
        resolution_ratio = raster_resolution / grid_resolution
    ...
    def _find_coverage_gaps(self, raster_path: Path, grid: BaseGrid, 
        ...
        # Sample cells (simple random sampling)
        import random
