# src/raster_data/loaders/geotiff_loader.py
...
class GeoTIFFLoader(BaseRasterLoader):
    ...
    def _close_dataset(self, dataset: gdal.Dataset) -> None:
        """Close GDAL dataset."""
        # GDAL datasets are closed by calling Close() method or setting to None
        # The variable assignment doesn't actually close the dataset,
        # but the dataset will be closed when it goes out of scope
        pass
