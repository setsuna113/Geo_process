# src/raster/loaders/base_loader.py
...
class BaseRasterLoader(ABC):
    ...
    def __init__(self, config: Config):
        self.config = config
        self.tile_size = config.get('raster_processing', {}).get('tile_size', 1000)
        self.memory_limit_mb = config.get('raster_processing', {}).get('memory_limit_mb', 1000)
        self.cache_size = config.get('raster_processing', {}).get('chunk_size_mb', 100)
